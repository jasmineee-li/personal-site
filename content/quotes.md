...
- Separate quotes with a line containing only `---`.
- End a quote with lines starting with `—` for attribution.
- Blank lines within a quote become paragraph breaks.
- Newest quotes go at the bottom; the site shows newest first.
